library(data.table)
base <- fread(input = paste0('lessons/dados_salarios.csv'), header = T, na.strings = 'NA', data.table = FALSE, dec = ',')
...
write.csv2(base, 'lessons/dados_salarios_alt.csv', row.names = FALSE)
